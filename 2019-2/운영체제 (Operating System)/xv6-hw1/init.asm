...
main(void)
{
  ...
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 54 08 00 00       	push   $0x854
  46:	6a 01                	push   $0x1
  48:	e8 73 04 00 00       	call   4c0 <printf>
  printf(1, "Name: Ki-Beom Jun \n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  ...
  cb:	68 32 08 00 00       	push   $0x832
  d0:	e8 b5 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  d5:	5a                   	pop    %edx
  d6:	59                   	pop    %ecx
  d7:	68 35 08 00 00       	push   $0x835
  dc:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 80 08 00 00       	mov    $0x880,%eax
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 2c 0b 00 00       	mov    %eax,0xb2c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 7bd:	0b 00 00 
 7c0:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 30 0b 00 00       	mov    $0xb30,%eax
 7cf:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7d6:	00 00 00 
