...
_infloop:     file format elf32-i386
...
putc(int fd, char c)
{
 ...
 398:	e8 d5 fe ff ff       	call   272 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 408:	50                   	push   %eax
 409:	57                   	push   %edi
 40a:	e8 63 fe ff ff       	call   272 <write>
...
putc(int fd, char c)
{
 ...
 46a:	50                   	push   %eax
 46b:	57                   	push   %edi
 46c:	e8 01 fe ff ff       	call   272 <write>
 ...
 481:	e8 ec fd ff ff       	call   272 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 54f:	50                   	push   %eax
 550:	57                   	push   %edi
 551:	e8 1c fd ff ff       	call   272 <write>
...
free(void *ap)
{
 ...
 561:	a1 78 09 00 00       	mov    0x978,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5b9:	a3 78 09 00 00       	mov    %eax,0x978
}
 5be:	5b                   	pop    %ebx
 5bf:	5e                   	pop    %esi
 5c0:	5f                   	pop    %edi
 ...
 5da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5dd:	a3 78 09 00 00       	mov    %eax,0x978
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 78 09 00 00    	mov    0x978,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 64f:	76 3f                	jbe    690 <malloc+0xa0>
    ...
    if(p == freep)
 651:	39 05 78 09 00 00    	cmp    %eax,0x978
 ...
 676:	e8 e5 fe ff ff       	call   560 <free>
  return freep;
 67b:	8b 15 78 09 00 00    	mov    0x978,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 69c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 69f:	89 15 78 09 00 00    	mov    %edx,0x978
      return (void*)(p + 1);
 ...
 6b4:	eb e9                	jmp    69f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6b6:	c7 05 78 09 00 00 7c 	movl   $0x97c,0x978
 6bd:	09 00 00 
 6c0:	c7 05 7c 09 00 00 7c 	movl   $0x97c,0x97c
 6c7:	09 00 00 
    base.s.size = 0;
 6ca:	b8 7c 09 00 00       	mov    $0x97c,%eax
 6cf:	c7 05 80 09 00 00 00 	movl   $0x0,0x980
 6d6:	00 00 00 
