...
int main(int argc, char* argv[]){
  ...
  2e:	ff 70 04             	pushl  0x4(%eax)
  31:	e8 4a 00 00 00       	call   80 <myatoi>
  ...
  39:	89 c3                	mov    %eax,%ebx
	...
	if((val = getnice(pid)) != -1)
  3b:	e8 5a 03 00 00       	call   39a <getnice>
  ...
  56:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  59:	e8 94 02 00 00       	call   2f2 <exit>
	pid = myatoi(argv[1]);
...
int myatoi(char str[])
{
  ...
  86:	8b 45 08             	mov    0x8(%ebp),%eax
	if (str[0]=='-') {
  89:	80 38 2d             	cmpb   $0x2d,(%eax)
  8c:	74 0a                	je     98 <myatoi+0x18>
		return -1*atoi(&str[1]);
	}
	else return atoi(str);
}
...
int myatoi(char str[])
{
  ...
  8f:	e9 ec 01 00 00       	jmp    280 <atoi>
...
int myatoi(char str[])
{
  ...
  9e:	50                   	push   %eax
  9f:	e8 dc 01 00 00       	call   280 <atoi>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	f7 f6                	div    %esi
 401:	0f b6 92 d0 07 00 00 	movzbl 0x7d0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 c9 07 00 00       	mov    $0x7c9,%eax
