...
int main(void){
 ...
 printf(1, "Hello OS !! \n");
  11:	68 10 07 00 00       	push   $0x710
  16:	6a 01                	push   $0x1
  18:	e8 d3 03 00 00       	call   3f0 <printf>
 printf(1, "Current # of NP : %d\n",getnp());
  1d:	e8 00 03 00 00       	call   322 <getnp>
  22:	83 c4 0c             	add    $0xc,%esp
  25:	50                   	push   %eax
  26:	68 1e 07 00 00       	push   $0x71e
  2b:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 3c 07 00 00 	movzbl 0x73c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 34 07 00 00       	mov    $0x734,%eax
...
free(void *ap)
{
 ...
 591:	a1 d4 09 00 00       	mov    0x9d4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 d4 09 00 00       	mov    %eax,0x9d4
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 d4 09 00 00       	mov    %eax,0x9d4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 d4 09 00 00    	mov    %edx,0x9d4
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 d4 09 00 00 d8 	movl   $0x9d8,0x9d4
 6ed:	09 00 00 
 6f0:	c7 05 d8 09 00 00 d8 	movl   $0x9d8,0x9d8
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 d8 09 00 00       	mov    $0x9d8,%eax
 6ff:	c7 05 dc 09 00 00 00 	movl   $0x0,0x9dc
 706:	00 00 00 
