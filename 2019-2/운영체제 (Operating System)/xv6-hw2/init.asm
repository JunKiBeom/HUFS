...
main(void)
{
  ...
  62:	6a 01                	push   $0x1
  64:	e8 57 04 00 00       	call   4c0 <printf>
  ...
  73:	68 0e 08 00 00       	push   $0x80e
  78:	6a 01                	push   $0x1
  7a:	e8 41 04 00 00       	call   4c0 <printf>
    pid = fork();
  7f:	e8 c6 02 00 00       	call   34a <fork>
    if(pid < 0){
  ...
  b1:	53                   	push   %ebx
  b2:	53                   	push   %ebx
  b3:	68 21 08 00 00       	push   $0x821
  b8:	6a 01                	push   $0x1
  ba:	e8 01 04 00 00       	call   4c0 <printf>
      exit();
  bf:	e8 8e 02 00 00       	call   352 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  c4:	50                   	push   %eax
  c5:	50                   	push   %eax
  c6:	68 28 0b 00 00       	push   $0xb28
  cb:	68 34 08 00 00       	push   $0x834
  d0:	e8 b5 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  d5:	5a                   	pop    %edx
  d6:	59                   	pop    %ecx
  d7:	68 37 08 00 00       	push   $0x837
  dc:	6a 01                	push   $0x1
  de:	e8 dd 03 00 00       	call   4c0 <printf>
      exit();
  e3:	e8 6a 02 00 00       	call   352 <exit>
main(void)
{
  int pid, wpid;
  ...
  e9:	6a 01                	push   $0x1
  eb:	6a 01                	push   $0x1
  ed:	68 e0 07 00 00       	push   $0x7e0
  f2:	e8 a3 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  f7:	5b                   	pop    %ebx
  f8:	58                   	pop    %eax
  f9:	6a 02                	push   $0x2
  fb:	68 e0 07 00 00       	push   $0x7e0
 100:	e8 8d 02 00 00       	call   392 <open>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 84 08 00 00       	mov    $0x884,%eax
...
free(void *ap)
{
 ...
 6b7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6b9:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 30 0b 00 00       	mov    %eax,0xb30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 30 0b 00 00    	mov    %edx,0xb30
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 7bd:	0b 00 00 
 7c0:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 34 0b 00 00       	mov    $0xb34,%eax
 7cf:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 7d6:	00 00 00 
