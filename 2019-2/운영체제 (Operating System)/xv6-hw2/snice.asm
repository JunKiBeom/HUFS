...
int main(int argc, char* argv[]){
  ...
  1e:	68 90 07 00 00       	push   $0x790
  23:	6a 01                	push   $0x1
  25:	e8 46 04 00 00       	call   470 <printf>
		exit();
  2a:	e8 d3 02 00 00       	call   302 <exit>
	}

	pid = myatoi(argv[1]); 
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	ff 73 04             	pushl  0x4(%ebx)
  35:	e8 56 00 00 00       	call   90 <myatoi>
  3a:	89 c6                	mov    %eax,%esi
	val = myatoi(argv[2]);
  3c:	58                   	pop    %eax
  3d:	ff 73 08             	pushl  0x8(%ebx)
  40:	e8 4b 00 00 00       	call   90 <myatoi>
  ...
  49:	89 c3                	mov    %eax,%ebx
	...
	if((rv = setnice(pid, val)) != -1)
  4b:	e8 62 03 00 00       	call   3b2 <setnice>
  50:	83 c4 10             	add    $0x10,%esp
  53:	83 c0 01             	add    $0x1,%eax
  56:	74 16                	je     6e <main+0x6e>
		printf(1, "Nice of PID <%d> is set to %d\n", pid, val);
  58:	53                   	push   %ebx
  59:	56                   	push   %esi
  5a:	68 a8 07 00 00       	push   $0x7a8
  5f:	6a 01                	push   $0x1
  ...
  66:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  69:	e8 94 02 00 00       	call   302 <exit>
	val = myatoi(argv[2]);
...
int myatoi(char str[])
{
  ...
  96:	8b 45 08             	mov    0x8(%ebp),%eax
	if (str[0]=='-') {
  99:	80 38 2d             	cmpb   $0x2d,(%eax)
  9c:	74 0a                	je     a8 <myatoi+0x18>
		return -1*atoi(&str[1]);
	}
	else return atoi(str);
}
...
int myatoi(char str[])
{
  ...
  9f:	e9 ec 01 00 00       	jmp    290 <atoi>
...
int myatoi(char str[])
{
  ...
  ae:	50                   	push   %eax
  af:	e8 dc 01 00 00       	call   290 <atoi>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40f:	f7 f6                	div    %esi
 411:	0f b6 92 04 08 00 00 	movzbl 0x804(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 588:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 58b:	b8 fc 07 00 00       	mov    $0x7fc,%eax
...
free(void *ap)
{
 ...
 611:	a1 cc 0a 00 00       	mov    0xacc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 667:	89 08                	mov    %ecx,(%eax)
  freep = p;
 669:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 ...
 68a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 cc 0a 00 00       	mov    %eax,0xacc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 764:	eb e9                	jmp    74f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 76d:	0a 00 00 
 770:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 d0 0a 00 00       	mov    $0xad0,%eax
 77f:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 786:	00 00 00 
