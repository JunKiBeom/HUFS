...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b9:	0f b6 80 60 0c 00 00 	movzbl 0xc60(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5f5:	75 25                	jne    61c <printf+0xff>
          s = "(null)";
 5f7:	c7 45 f4 ad 09 00 00 	movl   $0x9ad,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6bd:	a1 88 0c 00 00       	mov    0xc88,%eax
...
free(void *ap)
{
 ...
 788:	a3 88 0c 00 00       	mov    %eax,0xc88
}
 78d:	90                   	nop
 78e:	c9                   	leave  
 78f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7e6:	83 c4 10             	add    $0x10,%esp
  return freep;
 7e9:	a1 88 0c 00 00       	mov    0xc88,%eax
}
 7ee:	c9                   	leave  
 7ef:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 802:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 805:	a1 88 0c 00 00       	mov    0xc88,%eax
 80a:	89 45 f0             	mov    %eax,-0x10(%ebp)
 80d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 811:	75 23                	jne    836 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 813:	c7 45 f0 80 0c 00 00 	movl   $0xc80,-0x10(%ebp)
 81a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 81d:	a3 88 0c 00 00       	mov    %eax,0xc88
 822:	a1 88 0c 00 00       	mov    0xc88,%eax
 827:	a3 80 0c 00 00       	mov    %eax,0xc80
    base.s.size = 0;
 82c:	c7 05 84 0c 00 00 00 	movl   $0x0,0xc84
 833:	00 00 00 
  }
 ...
 889:	a3 88 0c 00 00       	mov    %eax,0xc88
      return (void*)(p + 1);
 ...
 894:	eb 3b                	jmp    8d1 <malloc+0xe1>
    ...
    if(p == freep)
 896:	a1 88 0c 00 00       	mov    0xc88,%eax
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 8dc:	68 00 10 00 00       	push   $0x1000
 8e1:	e8 0a ff ff ff       	call   7f0 <malloc>
 8e6:	83 c4 10             	add    $0x10,%esp
 8e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 8ec:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 8f0:	75 07                	jne    8f9 <hufs_thread_create+0x26>
 8f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 8f7:	eb 42                	jmp    93b <hufs_thread_create+0x68>
