...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	0f b6 80 34 0b 00 00 	movzbl 0xb34(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 512:	75 25                	jne    539 <printf+0xff>
          s = "(null)";
 514:	c7 45 f4 a4 08 00 00 	movl   $0x8a4,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5da:	a1 68 0b 00 00       	mov    0xb68,%eax
...
free(void *ap)
{
 ...
 6a5:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 6aa:	90                   	nop
 6ab:	c9                   	leave  
 6ac:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 703:	83 c4 10             	add    $0x10,%esp
  return freep;
 706:	a1 68 0b 00 00       	mov    0xb68,%eax
}
 70b:	c9                   	leave  
 70c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 71f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 722:	a1 68 0b 00 00       	mov    0xb68,%eax
 727:	89 45 f0             	mov    %eax,-0x10(%ebp)
 72a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 72e:	75 23                	jne    753 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 730:	c7 45 f0 60 0b 00 00 	movl   $0xb60,-0x10(%ebp)
 737:	8b 45 f0             	mov    -0x10(%ebp),%eax
 73a:	a3 68 0b 00 00       	mov    %eax,0xb68
 73f:	a1 68 0b 00 00       	mov    0xb68,%eax
 744:	a3 60 0b 00 00       	mov    %eax,0xb60
    base.s.size = 0;
 749:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 750:	00 00 00 
  }
 ...
 7a6:	a3 68 0b 00 00       	mov    %eax,0xb68
      return (void*)(p + 1);
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 7f9:	68 00 10 00 00       	push   $0x1000
 7fe:	e8 0a ff ff ff       	call   70d <malloc>
 803:	83 c4 10             	add    $0x10,%esp
 806:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 809:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 80d:	75 07                	jne    816 <hufs_thread_create+0x26>
 80f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 814:	eb 42                	jmp    858 <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
 816:	83 ec 04             	sub    $0x4,%esp
 819:	ff 75 f4             	pushl  -0xc(%ebp)
 81c:	ff 75 0c             	pushl  0xc(%ebp)
 81f:	ff 75 08             	pushl  0x8(%ebp)
 822:	e8 2c fb ff ff       	call   353 <clone>
 827:	83 c4 10             	add    $0x10,%esp
 82a:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
 82d:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
 831:	75 15                	jne    848 <hufs_thread_create+0x58>
		free(stack);
 833:	83 ec 0c             	sub    $0xc,%esp
 836:	ff 75 f4             	pushl  -0xc(%ebp)
 839:	e8 8d fd ff ff       	call   5cb <free>
 83e:	83 c4 10             	add    $0x10,%esp
		return -1;
 841:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 846:	eb 10                	jmp    858 <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
 848:	8b 45 f0             	mov    -0x10(%ebp),%eax
 84b:	8b 55 f4             	mov    -0xc(%ebp),%edx
 84e:	89 14 85 80 0b 00 00 	mov    %edx,0xb80(,%eax,4)
