...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4fc:	0f b6 80 7c 0c 00 00 	movzbl 0xc7c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 638:	75 25                	jne    65f <printf+0xff>
          s = "(null)";
 63a:	c7 45 f4 ed 09 00 00 	movl   $0x9ed,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 700:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
free(void *ap)
{
 ...
 7cb:	a3 a8 0c 00 00       	mov    %eax,0xca8
}
 7d0:	90                   	nop
 7d1:	c9                   	leave  
 7d2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 829:	83 c4 10             	add    $0x10,%esp
  return freep;
 82c:	a1 a8 0c 00 00       	mov    0xca8,%eax
}
 831:	c9                   	leave  
 832:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 845:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 848:	a1 a8 0c 00 00       	mov    0xca8,%eax
 84d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 850:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 854:	75 23                	jne    879 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 856:	c7 45 f0 a0 0c 00 00 	movl   $0xca0,-0x10(%ebp)
 85d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 860:	a3 a8 0c 00 00       	mov    %eax,0xca8
 865:	a1 a8 0c 00 00       	mov    0xca8,%eax
 86a:	a3 a0 0c 00 00       	mov    %eax,0xca0
    base.s.size = 0;
 86f:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 876:	00 00 00 
  }
 ...
 8cc:	a3 a8 0c 00 00       	mov    %eax,0xca8
      return (void*)(p + 1);
 ...
 8d7:	eb 3b                	jmp    914 <malloc+0xe1>
    ...
    if(p == freep)
 8d9:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 91f:	68 00 10 00 00       	push   $0x1000
 924:	e8 0a ff ff ff       	call   833 <malloc>
 929:	83 c4 10             	add    $0x10,%esp
 92c:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 92f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 933:	75 07                	jne    93c <hufs_thread_create+0x26>
 935:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 93a:	eb 42                	jmp    97e <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
 93c:	83 ec 04             	sub    $0x4,%esp
 93f:	ff 75 f4             	pushl  -0xc(%ebp)
 942:	ff 75 0c             	pushl  0xc(%ebp)
 945:	ff 75 08             	pushl  0x8(%ebp)
 948:	e8 2c fb ff ff       	call   479 <clone>
 94d:	83 c4 10             	add    $0x10,%esp
 950:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
 953:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
 957:	75 15                	jne    96e <hufs_thread_create+0x58>
		free(stack);
 959:	83 ec 0c             	sub    $0xc,%esp
 95c:	ff 75 f4             	pushl  -0xc(%ebp)
 95f:	e8 8d fd ff ff       	call   6f1 <free>
 964:	83 c4 10             	add    $0x10,%esp
		return -1;
 967:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 96c:	eb 10                	jmp    97e <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
 96e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 971:	8b 55 f4             	mov    -0xc(%ebp),%edx
 974:	89 14 85 c0 0c 00 00 	mov    %edx,0xcc0(,%eax,4)
...
int hufs_thread_join(int pid)
{
 ...
 989:	8b 04 85 c0 0c 00 00 	mov    0xcc0(,%eax,4),%eax
 990:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (stack==0) return -1;
 993:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 997:	75 07                	jne    9a0 <hufs_thread_join+0x20>
 999:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 99e:	eb 28                	jmp    9c8 <hufs_thread_join+0x48>

	join(&thread_info[pid].stack);	
 9a0:	8b 45 08             	mov    0x8(%ebp),%eax
 9a3:	c1 e0 02             	shl    $0x2,%eax
 9a6:	05 c0 0c 00 00       	add    $0xcc0,%eax
 9ab:	83 ec 0c             	sub    $0xc,%esp
 9ae:	50                   	push   %eax
 9af:	e8 cd fa ff ff       	call   481 <join>
 9b4:	83 c4 10             	add    $0x10,%esp
	free(stack);
 9b7:	83 ec 0c             	sub    $0xc,%esp
 9ba:	ff 75 f4             	pushl  -0xc(%ebp)
 9bd:	e8 2f fd ff ff       	call   6f1 <free>
