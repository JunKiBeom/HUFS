...
fmtname(char *path)
{
  ...
  9a:	05 20 0f 00 00       	add    $0xf20,%eax
  ...
  return buf;
  ae:	b8 20 0f 00 00       	mov    $0xf20,%eax
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6f0:	0f b6 80 f0 0e 00 00 	movzbl 0xef0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 82c:	75 25                	jne    853 <printf+0xff>
          s = "(null)";
 82e:	c7 45 f4 08 0c 00 00 	movl   $0xc08,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8f4:	a1 38 0f 00 00       	mov    0xf38,%eax
...
free(void *ap)
{
 ...
 9bf:	a3 38 0f 00 00       	mov    %eax,0xf38
}
 9c4:	90                   	nop
 9c5:	c9                   	leave  
 9c6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a1d:	83 c4 10             	add    $0x10,%esp
  return freep;
 a20:	a1 38 0f 00 00       	mov    0xf38,%eax
}
 a25:	c9                   	leave  
 a26:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a39:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a3c:	a1 38 0f 00 00       	mov    0xf38,%eax
 a41:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a44:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a48:	75 23                	jne    a6d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a4a:	c7 45 f0 30 0f 00 00 	movl   $0xf30,-0x10(%ebp)
 a51:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a54:	a3 38 0f 00 00       	mov    %eax,0xf38
 a59:	a1 38 0f 00 00       	mov    0xf38,%eax
 a5e:	a3 30 0f 00 00       	mov    %eax,0xf30
    base.s.size = 0;
 a63:	c7 05 34 0f 00 00 00 	movl   $0x0,0xf34
 a6a:	00 00 00 
  }
 ...
 ac0:	a3 38 0f 00 00       	mov    %eax,0xf38
      return (void*)(p + 1);
 ...
 acb:	eb 3b                	jmp    b08 <malloc+0xe1>
    ...
    if(p == freep)
 acd:	a1 38 0f 00 00       	mov    0xf38,%eax
...
00000b74 <hufs_thread_join>:

int hufs_thread_join(int pid)
{
 b74:	55                   	push   %ebp
 b75:	89 e5                	mov    %esp,%ebp
 b77:	83 ec 18             	sub    $0x18,%esp
	void *stack = thread_info[pid].stack;
 b7a:	8b 45 08             	mov    0x8(%ebp),%eax
 b7d:	8b 04 85 40 0f 00 00 	mov    0xf40(,%eax,4),%eax
 b84:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (stack==0) return -1;
 b87:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b8b:	75 07                	jne    b94 <hufs_thread_join+0x20>
 b8d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 b92:	eb 28                	jmp    bbc <hufs_thread_join+0x48>

	join(&thread_info[pid].stack);	
 b94:	8b 45 08             	mov    0x8(%ebp),%eax
 b97:	c1 e0 02             	shl    $0x2,%eax
 b9a:	05 40 0f 00 00       	add    $0xf40,%eax
 b9f:	83 ec 0c             	sub    $0xc,%esp
 ba2:	50                   	push   %eax
 ba3:	e8 cd fa ff ff       	call   675 <join>
 ba8:	83 c4 10             	add    $0x10,%esp
	free(stack);
 bab:	83 ec 0c             	sub    $0xc,%esp
 bae:	ff 75 f4             	pushl  -0xc(%ebp)
 bb1:	e8 2f fd ff ff       	call   8e5 <free>
