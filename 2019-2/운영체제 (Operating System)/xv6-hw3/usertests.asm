...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      30:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      5f:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      8e:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      bd:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "iput test ok\n");
      d8:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      f7:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     11b:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     152:	79 1b                	jns    16f <exitiputtest+0x7e>
      printf(stdout, "mkdir failed\n");
     154:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    if(chdir("iputdir") < 0){
     ...
     183:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    if(unlink("../iputdir") < 0){
     ...
     1b0:	79 1b                	jns    1cd <exitiputtest+0xdc>
      printf(stdout, "unlink ../iputdir failed\n");
     1b2:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "exitiput test ok\n");
     1d7:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1f6:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     220:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     249:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     285:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "openiput test ok\n");
     2e6:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     305:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     336:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     37a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "open test ok\n");
     395:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     3b4:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3e8:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     40a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     43f:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     477:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "writes ok\n");
     49f:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4de:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  i = read(fd, buf, 2000);
     ...
     4fc:	68 e0 8b 00 00       	push   $0x8be0
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     51a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     535:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     56f:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     58a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "small file test ok\n");
     5a5:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     5c4:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5f8:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     645:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     69a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     6c4:	68 e0 8b 00 00       	push   $0x8be0
    ...
    if(i == 0){
     ...
     6e6:	a1 ec 63 00 00       	mov    0x63ec,%eax
     ...
     70d:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    if(((int*)buf)[0] != n){
     ...
     73e:	a1 ec 63 00 00       	mov    0x63ec,%eax
     743:	52                   	push   %edx
  ...
  if(unlink("big") < 0){
    ...
    printf(stdout, "unlink big failed\n");
     786:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "big files ok\n");
     7a1:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     7c0:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  name[0] = 'a';
     7d6:	c6 05 e0 ab 00 00 61 	movb   $0x61,0xabe0
  name[2] = '\0';
     7dd:	c6 05 e2 ab 00 00 00 	movb   $0x0,0xabe2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7f3:	a2 e1 ab 00 00       	mov    %al,0xabe1
    fd = open(name, O_CREATE|O_RDWR);
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 02 02 00 00       	push   $0x202
     800:	68 e0 ab 00 00       	push   $0xabe0
  ...
  name[0] = 'a';
     828:	c6 05 e0 ab 00 00 61 	movb   $0x61,0xabe0
  name[2] = '\0';
     82f:	c6 05 e2 ab 00 00 00 	movb   $0x0,0xabe2
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     845:	a2 e1 ab 00 00       	mov    %al,0xabe1
    unlink(name);
     84a:	83 ec 0c             	sub    $0xc,%esp
     84d:	68 e0 ab 00 00       	push   $0xabe0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     864:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     883:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     8ad:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     8dc:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     90b:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     93a:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "mkdir test ok\n");
     955:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     974:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(exec("echo", echoargv) < 0){
     ...
     98d:	68 d8 63 00 00       	push   $0x63d8
    ...
    printf(stdout, "exec echo failed\n");
     9a3:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a39:	05 e0 8b 00 00       	add    $0x8be0,%eax
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a58:	68 e0 8b 00 00       	push   $0x8be0
     a5d:	50                   	push   %eax
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ac8:	05 e0 8b 00 00       	add    $0x8be0,%eax
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     b2b:	68 e0 8b 00 00       	push   $0x8be0
     b30:	50                   	push   %eax
...
preempt(void)
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c66:	68 e0 8b 00 00       	push   $0x8be0
     c6b:	50                   	push   %eax
...
fourfiles(void)
{
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1121:	50                   	push   %eax
    1122:	68 e0 8b 00 00       	push   $0x8be0
    ...
    1140:	68 e0 8b 00 00       	push   $0x8be0
  ...
  for(i = 0; i < 2; i++){
    ...
    11e9:	05 e0 8b 00 00       	add    $0x8be0,%eax
  ...
  for(i = 0; i < 2; i++){
    ...
    122f:	68 e0 8b 00 00       	push   $0x8be0
...
unlinkread(void)
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	68 e0 8b 00 00       	push   $0x8be0
  ...
  if(buf[0] != 'h'){
    1658:	0f b6 05 e0 8b 00 00 	movzbl 0x8be0,%eax
  ...
  if(write(fd, buf, 10) != 10){
    ...
    167d:	6a 0a                	push   $0xa
    167f:	68 e0 8b 00 00       	push   $0x8be0
...
linktest(void)
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1831:	68 e0 8b 00 00       	push   $0x8be0
...
subdir(void)
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2111:	68 e0 8b 00 00       	push   $0x8be0
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    212a:	0f b6 05 e0 8b 00 00 	movzbl 0x8be0,%eax
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22c8:	68 e0 8b 00 00       	push   $0x8be0
...
bigwrite(void)
{
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    273a:	68 e0 8b 00 00       	push   $0x8be0
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2831:	68 e0 8b 00 00       	push   $0x8be0
    ...
    2846:	68 e0 8b 00 00       	push   $0x8be0
  ...
  for(i = 0; ; i++){
    ...
    28d4:	68 e0 8b 00 00       	push   $0x8be0
    ...
    292a:	0f b6 05 e0 8b 00 00 	movzbl 0x8be0,%eax
    ...
    2944:	0f b6 05 0b 8d 00 00 	movzbl 0x8d0b,%eax
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30fc:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3153:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(pid < 0){
    ...
    31a1:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(c != a + 1){
    ...
    31e7:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    324b:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    329c:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(c != a - 4096){
    ...
    32d4:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3338:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(*lastaddr == 99){
    ...
    3360:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(c != a){
    ...
    33b6:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f1:	79 1b                	jns    340e <sbrktest+0x319>
      printf(stdout, "fork failed\n");
    33f3:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    341d:	a1 ec 63 00 00       	mov    0x63ec,%eax
    3422:	52                   	push   %edx
  ...
  if(c == (char*)0xffffffff){
    ...
    357b:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "sbrk test OK\n");
    35c8:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    360d:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    369e:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  printf(stdout, "validate ok\n");
    36cc:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36eb:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3742:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    378f:	c7 04 85 20 64 00 00 	movl   $0x5af4,0x6420(,%eax,4)
    3796:	f4 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    37a2:	7e e8                	jle    378c <bigargtest+0x31>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    37a4:	c7 05 9c 64 00 00 00 	movl   $0x0,0x649c
    37ab:	00 00 00 
    printf(stdout, "bigarg test\n");
    37ae:	a1 ec 63 00 00       	mov    0x63ec,%eax
    ...
    3820:	a1 ec 63 00 00       	mov    0x63ec,%eax
  ...
  if(fd < 0){
    ...
    385b:	a1 ec 63 00 00       	mov    0x63ec,%eax
...
fsfull()
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    39e0:	68 e0 8b 00 00       	push   $0x8be0
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b41:	a1 f0 63 00 00       	mov    0x63f0,%eax
    3b46:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b4c:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b51:	a3 f0 63 00 00       	mov    %eax,0x63f0
  return randstate;
    3b56:	a1 f0 63 00 00       	mov    0x63f0,%eax
}
    3b5b:	5d                   	pop    %ebp
    3b5c:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3b71:	68 6b 5c 00 00       	push   $0x5c6b
    3b76:	6a 01                	push   $0x1
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3b83:	6a 00                	push   $0x0
    3b85:	68 7f 5c 00 00       	push   $0x5c7f
    ...
    3b99:	68 90 5c 00 00       	push   $0x5c90
    3b9e:	6a 01                	push   $0x1
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3bb5:	68 7f 5c 00 00       	push   $0x5c7f
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4022:	0f b6 80 f4 63 00 00 	movzbl 0x63f4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    415e:	75 25                	jne    4185 <printf+0xff>
          s = "(null)";
    4160:	c7 45 f4 ba 5c 00 00 	movl   $0x5cba,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4226:	a1 a8 64 00 00       	mov    0x64a8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42f1:	a3 a8 64 00 00       	mov    %eax,0x64a8
}
    42f6:	90                   	nop
    42f7:	c9                   	leave  
    42f8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    4352:	a1 a8 64 00 00       	mov    0x64a8,%eax
}
    4357:	c9                   	leave  
    4358:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    436e:	a1 a8 64 00 00       	mov    0x64a8,%eax
    4373:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4376:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    437a:	75 23                	jne    439f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    437c:	c7 45 f0 a0 64 00 00 	movl   $0x64a0,-0x10(%ebp)
    4383:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4386:	a3 a8 64 00 00       	mov    %eax,0x64a8
    438b:	a1 a8 64 00 00       	mov    0x64a8,%eax
    4390:	a3 a0 64 00 00       	mov    %eax,0x64a0
    base.s.size = 0;
    4395:	c7 05 a4 64 00 00 00 	movl   $0x0,0x64a4
    439c:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43f2:	a3 a8 64 00 00       	mov    %eax,0x64a8
      return (void*)(p + 1);
    ...
    if(p == freep)
    43ff:	a1 a8 64 00 00       	mov    0x64a8,%eax
...
int hufs_thread_create(void *func(), void *args)
{
	...
	stack = malloc(4096);
    4442:	83 ec 0c             	sub    $0xc,%esp
    4445:	68 00 10 00 00       	push   $0x1000
    444a:	e8 0a ff ff ff       	call   4359 <malloc>
    444f:	83 c4 10             	add    $0x10,%esp
    4452:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
    4455:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4459:	75 07                	jne    4462 <hufs_thread_create+0x26>
    445b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    4460:	eb 42                	jmp    44a4 <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
    4462:	83 ec 04             	sub    $0x4,%esp
    4465:	ff 75 f4             	pushl  -0xc(%ebp)
    4468:	ff 75 0c             	pushl  0xc(%ebp)
    446b:	ff 75 08             	pushl  0x8(%ebp)
    446e:	e8 2c fb ff ff       	call   3f9f <clone>
    4473:	83 c4 10             	add    $0x10,%esp
    4476:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
    4479:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
    447d:	75 15                	jne    4494 <hufs_thread_create+0x58>
		free(stack);
    447f:	83 ec 0c             	sub    $0xc,%esp
    4482:	ff 75 f4             	pushl  -0xc(%ebp)
    4485:	e8 8d fd ff ff       	call   4217 <free>
    448a:	83 c4 10             	add    $0x10,%esp
		return -1;
    448d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    4492:	eb 10                	jmp    44a4 <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
    4494:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4497:	8b 55 f4             	mov    -0xc(%ebp),%edx
    449a:	89 14 85 00 ac 00 00 	mov    %edx,0xac00(,%eax,4)
...
000044a6 <hufs_thread_join>:

int hufs_thread_join(int pid)
{
    44a6:	55                   	push   %ebp
    44a7:	89 e5                	mov    %esp,%ebp
    44a9:	83 ec 18             	sub    $0x18,%esp
	void *stack = thread_info[pid].stack;
    44ac:	8b 45 08             	mov    0x8(%ebp),%eax
    44af:	8b 04 85 00 ac 00 00 	mov    0xac00(,%eax,4),%eax
    44b6:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (stack==0) return -1;
    44b9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    44bd:	75 07                	jne    44c6 <hufs_thread_join+0x20>
    44bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    44c4:	eb 28                	jmp    44ee <hufs_thread_join+0x48>

	join(&thread_info[pid].stack);	
    44c6:	8b 45 08             	mov    0x8(%ebp),%eax
    44c9:	c1 e0 02             	shl    $0x2,%eax
    44cc:	05 00 ac 00 00       	add    $0xac00,%eax
    44d1:	83 ec 0c             	sub    $0xc,%esp
    44d4:	50                   	push   %eax
    44d5:	e8 cd fa ff ff       	call   3fa7 <join>
    44da:	83 c4 10             	add    $0x10,%esp
	free(stack);
    44dd:	83 ec 0c             	sub    $0xc,%esp
    44e0:	ff 75 f4             	pushl  -0xc(%ebp)
    44e3:	e8 2f fd ff ff       	call   4217 <free>
