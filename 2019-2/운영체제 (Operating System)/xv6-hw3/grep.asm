...
grep(char *pattern, int fd)
{
  ...
  15:	01 45 f4             	add    %eax,-0xc(%ebp)
    p = buf;
  18:	c7 45 f0 40 0f 00 00 	movl   $0xf40,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  82:	75 9d                	jne    21 <grep+0x21>
    ...
    if(p == buf)
  84:	81 7d f0 40 0f 00 00 	cmpl   $0xf40,-0x10(%ebp)
  ...
  9d:	ba 40 0f 00 00       	mov    $0xf40,%edx
  ...
  ba:	83 c4 10             	add    $0x10,%esp
{
  ...
  ce:	05 40 0f 00 00       	add    $0xf40,%eax
...
putc(int fd, char c)
{
 ...
 67a:	e8 23 ff ff ff       	call   5a2 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d5:	0f b6 80 f0 0e 00 00 	movzbl 0xef0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 811:	75 25                	jne    838 <printf+0xff>
          s = "(null)";
 813:	c7 45 f4 da 0b 00 00 	movl   $0xbda,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 8d9:	a1 28 0f 00 00       	mov    0xf28,%eax
...
free(void *ap)
{
 ...
 9a4:	a3 28 0f 00 00       	mov    %eax,0xf28
}
 9a9:	90                   	nop
 9aa:	c9                   	leave  
 9ab:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 9cb:	50                   	push   %eax
 9cc:	e8 39 fc ff ff       	call   60a <sbrk>
 ...
 a02:	83 c4 10             	add    $0x10,%esp
  return freep;
 a05:	a1 28 0f 00 00       	mov    0xf28,%eax
}
 a0a:	c9                   	leave  
 a0b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a1e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a21:	a1 28 0f 00 00       	mov    0xf28,%eax
 a26:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a29:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a2d:	75 23                	jne    a52 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 45 f0 20 0f 00 00 	movl   $0xf20,-0x10(%ebp)
 a36:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a39:	a3 28 0f 00 00       	mov    %eax,0xf28
 a3e:	a1 28 0f 00 00       	mov    0xf28,%eax
 a43:	a3 20 0f 00 00       	mov    %eax,0xf20
    base.s.size = 0;
 a48:	c7 05 24 0f 00 00 00 	movl   $0x0,0xf24
 a4f:	00 00 00 
  }
 ...
 aa5:	a3 28 0f 00 00       	mov    %eax,0xf28
      return (void*)(p + 1);
 ...
 ab0:	eb 3b                	jmp    aed <malloc+0xe1>
    ...
    if(p == freep)
 ab2:	a1 28 0f 00 00       	mov    0xf28,%eax
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 af8:	68 00 10 00 00       	push   $0x1000
 afd:	e8 0a ff ff ff       	call   a0c <malloc>
 b02:	83 c4 10             	add    $0x10,%esp
 b05:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 b08:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b0c:	75 07                	jne    b15 <hufs_thread_create+0x26>
 b0e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 b13:	eb 42                	jmp    b57 <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
 b15:	83 ec 04             	sub    $0x4,%esp
 b18:	ff 75 f4             	pushl  -0xc(%ebp)
 b1b:	ff 75 0c             	pushl  0xc(%ebp)
 b1e:	ff 75 08             	pushl  0x8(%ebp)
 b21:	e8 2c fb ff ff       	call   652 <clone>
 b26:	83 c4 10             	add    $0x10,%esp
 b29:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
 b2c:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
 b30:	75 15                	jne    b47 <hufs_thread_create+0x58>
		free(stack);
 b32:	83 ec 0c             	sub    $0xc,%esp
 b35:	ff 75 f4             	pushl  -0xc(%ebp)
 b38:	e8 8d fd ff ff       	call   8ca <free>
 b3d:	83 c4 10             	add    $0x10,%esp
		return -1;
 b40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 b45:	eb 10                	jmp    b57 <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
 b47:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b4a:	8b 55 f4             	mov    -0xc(%ebp),%edx
 b4d:	89 14 85 40 13 00 00 	mov    %edx,0x1340(,%eax,4)
