...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 24 15 00 00 	mov    0x1524(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 f8 14 00 00       	push   $0x14f8
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      6b:	50                   	push   %eax
      6c:	68 ff 14 00 00       	push   $0x14ff
      71:	6a 02                	push   $0x2
      73:	e8 14 10 00 00       	call   108c <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      be:	50                   	push   %eax
      bf:	68 0f 15 00 00       	push   $0x150f
      c4:	6a 02                	push   $0x2
      c6:	e8 c1 0f 00 00       	call   108c <printf>
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 1f 15 00 00       	push   $0x151f
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 3c 15 00 00       	push   $0x153c
     259:	6a 02                	push   $0x2
     25b:	e8 2c 0e 00 00       	call   108c <printf>
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 3f 15 00 00       	push   $0x153f
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 47 15 00 00       	push   $0x1547
     347:	6a 02                	push   $0x2
     349:	e8 3e 0d 00 00       	call   108c <printf>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 55 15 00 00       	push   $0x1555
     3ad:	6a 02                	push   $0x2
     3af:	e8 d8 0c 00 00       	call   108c <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 59 15 00 00       	push   $0x1559
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 6a 0f 00 00       	call   135f <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 34 0f 00 00       	call   135f <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 d1 0e 00 00       	call   135f <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 89 0e 00 00       	call   135f <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 41 0e 00 00       	call   135f <malloc>
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 b4 1a 00 00       	push   $0x1ab4
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 b4 1a 00 00       	push   $0x1ab4
     ...
     63c:	50                   	push   %eax
     63d:	68 bc 1a 00 00       	push   $0x1abc
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 b4 1a 00 00       	push   $0x1ab4
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 b4 1a 00 00       	push   $0x1ab4
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 5e 15 00 00       	push   $0x155e
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 5f 15 00 00       	push   $0x155f
     772:	6a 02                	push   $0x2
     774:	e8 13 09 00 00       	call   108c <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 6e 15 00 00       	push   $0x156e
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 75 15 00 00       	push   $0x1575
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 77 15 00 00       	push   $0x1577
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 79 15 00 00       	push   $0x1579
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 7b 15 00 00       	push   $0x157b
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 98 15 00 00       	push   $0x1598
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 9b 15 00 00       	push   $0x159b
    ...
    panic("parseblock");
     ...
     9c4:	68 9d 15 00 00       	push   $0x159d
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 a8 15 00 00       	push   $0x15a8
    ...
    panic("syntax - missing )");
     ...
     a14:	68 aa 15 00 00       	push   $0x15aa
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 9b 15 00 00       	push   $0x159b
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 6e 15 00 00       	push   $0x156e
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 bd 15 00 00       	push   $0x15bd
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 cb 15 00 00       	push   $0x15cb
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 d0 15 00 00 	mov    0x15d0(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fdf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fe6:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fea:	74 17                	je     1003 <printint+0x2b>
     fec:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     ff0:	79 11                	jns    1003 <printint+0x2b>
    neg = 1;
     ff2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     ff9:	8b 45 0c             	mov    0xc(%ebp),%eax
     ffc:	f7 d8                	neg    %eax
     ffe:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1001:	eb 06                	jmp    1009 <printint+0x31>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    1010:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    1013:	8d 41 01             	lea    0x1(%ecx),%eax
    1016:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1019:	8b 5d 10             	mov    0x10(%ebp),%ebx
    101c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    101f:	ba 00 00 00 00       	mov    $0x0,%edx
    1024:	f7 f3                	div    %ebx
    1026:	89 d0                	mov    %edx,%eax
    1028:	0f b6 80 c4 1a 00 00 	movzbl 0x1ac4(%eax),%eax
    102f:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    1033:	8b 5d 10             	mov    0x10(%ebp),%ebx
    ...
    1047:	75 c7                	jne    1010 <printint+0x38>
  if(neg)
    1049:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    104d:	74 2d                	je     107c <printint+0xa4>
    buf[i++] = '-';
    104f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1052:	8d 50 01             	lea    0x1(%eax),%edx
    1055:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1058:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    105d:	eb 1d                	jmp    107c <printint+0xa4>
    putc(fd, buf[i]);
    105f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    1074:	e8 3c ff ff ff       	call   fb5 <putc>
  ...
  while(--i >= 0)
    107c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1080:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1084:	79 d9                	jns    105f <printint+0x87>
    putc(fd, buf[i]);
}
    1086:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
    ...
    108f:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    1092:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1099:	8d 45 0c             	lea    0xc(%ebp),%eax
    109c:	83 c0 04             	add    $0x4,%eax
    109f:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    10a2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    10a9:	e9 59 01 00 00       	jmp    1207 <printf+0x17b>
    c = fmt[i] & 0xff;
    ...
    10bc:	25 ff 00 00 00       	and    $0xff,%eax
    10c1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    10c4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10c8:	75 2c                	jne    10f6 <printf+0x6a>
      if(c == '%'){
    10ca:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    10ce:	75 0c                	jne    10dc <printf+0x50>
        state = '%';
    10d0:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    10d7:	e9 27 01 00 00       	jmp    1203 <printf+0x177>
      } else {
        putc(fd, c);
    ...
    10e9:	e8 c7 fe ff ff       	call   fb5 <putc>
    10ee:	83 c4 10             	add    $0x10,%esp
    10f1:	e9 0d 01 00 00       	jmp    1203 <printf+0x177>
      }
    } else if(state == '%'){
    10f6:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    10fa:	0f 85 03 01 00 00    	jne    1203 <printf+0x177>
      if(c == 'd'){
    1100:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1104:	75 1e                	jne    1124 <printf+0x98>
        printint(fd, *ap, 10, 1);
    1106:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1109:	8b 00                	mov    (%eax),%eax
    110b:	6a 01                	push   $0x1
    110d:	6a 0a                	push   $0xa
    110f:	50                   	push   %eax
    1110:	ff 75 08             	pushl  0x8(%ebp)
    1113:	e8 c0 fe ff ff       	call   fd8 <printint>
    1118:	83 c4 10             	add    $0x10,%esp
        ap++;
    111b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    111f:	e9 d8 00 00 00       	jmp    11fc <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    1124:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    1128:	74 06                	je     1130 <printf+0xa4>
    112a:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    112e:	75 1e                	jne    114e <printf+0xc2>
        printint(fd, *ap, 16, 0);
    1130:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1133:	8b 00                	mov    (%eax),%eax
    1135:	6a 00                	push   $0x0
    1137:	6a 10                	push   $0x10
    1139:	50                   	push   %eax
    113a:	ff 75 08             	pushl  0x8(%ebp)
    113d:	e8 96 fe ff ff       	call   fd8 <printint>
    1142:	83 c4 10             	add    $0x10,%esp
        ap++;
    1145:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1149:	e9 ae 00 00 00       	jmp    11fc <printf+0x170>
      } else if(c == 's'){
    114e:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    1152:	75 43                	jne    1197 <printf+0x10b>
        s = (char*)*ap;
    1154:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1157:	8b 00                	mov    (%eax),%eax
    1159:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    115c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    1160:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1164:	75 25                	jne    118b <printf+0xff>
          s = "(null)";
    1166:	c7 45 f4 e8 15 00 00 	movl   $0x15e8,-0xc(%ebp)
        while(*s != 0){
    116d:	eb 1c                	jmp    118b <printf+0xff>
          putc(fd, *s);
    ...
    117f:	e8 31 fe ff ff       	call   fb5 <putc>
    1184:	83 c4 10             	add    $0x10,%esp
          s++;
    1187:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    1193:	75 da                	jne    116f <printf+0xe3>
    1195:	eb 65                	jmp    11fc <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1197:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    119b:	75 1d                	jne    11ba <printf+0x12e>
        putc(fd, *ap);
    ...
    11ac:	e8 04 fe ff ff       	call   fb5 <putc>
    11b1:	83 c4 10             	add    $0x10,%esp
        ap++;
    11b4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11b8:	eb 42                	jmp    11fc <printf+0x170>
      } else if(c == '%'){
    11ba:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    11be:	75 17                	jne    11d7 <printf+0x14b>
        putc(fd, c);
    11c0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    11c3:	0f be c0             	movsbl %al,%eax
    11c6:	83 ec 08             	sub    $0x8,%esp
    11c9:	50                   	push   %eax
    11ca:	ff 75 08             	pushl  0x8(%ebp)
    11cd:	e8 e3 fd ff ff       	call   fb5 <putc>
    11d2:	83 c4 10             	add    $0x10,%esp
    11d5:	eb 25                	jmp    11fc <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    11d7:	83 ec 08             	sub    $0x8,%esp
    11da:	6a 25                	push   $0x25
    11dc:	ff 75 08             	pushl  0x8(%ebp)
    11df:	e8 d1 fd ff ff       	call   fb5 <putc>
    ...
    11f4:	e8 bc fd ff ff       	call   fb5 <putc>
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1203:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    ...
    1214:	0f 85 94 fe ff ff    	jne    10ae <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    ...
    1226:	83 e8 08             	sub    $0x8,%eax
    1229:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    122c:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    1231:	89 45 fc             	mov    %eax,-0x4(%ebp)
    1234:	eb 24                	jmp    125a <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1236:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1239:	8b 00                	mov    (%eax),%eax
    123b:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    123e:	77 12                	ja     1252 <free+0x35>
    1240:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1243:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1246:	77 24                	ja     126c <free+0x4f>
    1248:	8b 45 fc             	mov    -0x4(%ebp),%eax
    124b:	8b 00                	mov    (%eax),%eax
    124d:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1250:	77 1a                	ja     126c <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    125d:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1260:	76 d4                	jbe    1236 <free+0x19>
    1262:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1265:	8b 00                	mov    (%eax),%eax
    1267:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    126a:	76 ca                	jbe    1236 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    126c:	8b 45 f8             	mov    -0x8(%ebp),%eax
    126f:	8b 40 04             	mov    0x4(%eax),%eax
    1272:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    1279:	8b 45 f8             	mov    -0x8(%ebp),%eax
    127c:	01 c2                	add    %eax,%edx
    127e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1281:	8b 00                	mov    (%eax),%eax
    1283:	39 c2                	cmp    %eax,%edx
    1285:	75 24                	jne    12ab <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    1287:	8b 45 f8             	mov    -0x8(%ebp),%eax
    128a:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    12a2:	8b 10                	mov    (%eax),%edx
    12a4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12a7:	89 10                	mov    %edx,(%eax)
    12a9:	eb 0a                	jmp    12b5 <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    1305:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    130c:	77 07                	ja     1315 <morecore+0x16>
    nu = 4096;
    130e:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    1315:	8b 45 08             	mov    0x8(%ebp),%eax
    1318:	c1 e0 03             	shl    $0x3,%eax
    131b:	83 ec 0c             	sub    $0xc,%esp
    131e:	50                   	push   %eax
    131f:	e8 39 fc ff ff       	call   f5d <sbrk>
    1324:	83 c4 10             	add    $0x10,%esp
    1327:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    132a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    132e:	75 07                	jne    1337 <morecore+0x38>
    return 0;
    1330:	b8 00 00 00 00       	mov    $0x0,%eax
    1335:	eb 26                	jmp    135d <morecore+0x5e>
  hp = (Header*)p;
    1337:	8b 45 f4             	mov    -0xc(%ebp),%eax
    133a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    133d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1340:	8b 55 08             	mov    0x8(%ebp),%edx
    1343:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1346:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1349:	83 c0 08             	add    $0x8,%eax
    134c:	83 ec 0c             	sub    $0xc,%esp
    134f:	50                   	push   %eax
    1350:	e8 c8 fe ff ff       	call   121d <free>
    1355:	83 c4 10             	add    $0x10,%esp
  return freep;
    1358:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
}
    135d:	c9                   	leave  
    135e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1368:	83 c0 07             	add    $0x7,%eax
    136b:	c1 e8 03             	shr    $0x3,%eax
    136e:	83 c0 01             	add    $0x1,%eax
    1371:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1374:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    1379:	89 45 f0             	mov    %eax,-0x10(%ebp)
    137c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1380:	75 23                	jne    13a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1382:	c7 45 f0 44 1b 00 00 	movl   $0x1b44,-0x10(%ebp)
    1389:	8b 45 f0             	mov    -0x10(%ebp),%eax
    138c:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
    1391:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    1396:	a3 44 1b 00 00       	mov    %eax,0x1b44
    base.s.size = 0;
    139b:	c7 05 48 1b 00 00 00 	movl   $0x0,0x1b48
    13a2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    13b3:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    13b6:	72 4d                	jb     1405 <malloc+0xa6>
      if(p->s.size == nunits)
    13b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13bb:	8b 40 04             	mov    0x4(%eax),%eax
    13be:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    13c1:	75 0c                	jne    13cf <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    13c3:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13c6:	8b 10                	mov    (%eax),%edx
    13c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13cb:	89 10                	mov    %edx,(%eax)
    13cd:	eb 26                	jmp    13f5 <malloc+0x96>
      else {
        p->s.size -= nunits;
    13cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13d2:	8b 40 04             	mov    0x4(%eax),%eax
    13d5:	2b 45 ec             	sub    -0x14(%ebp),%eax
    13d8:	89 c2                	mov    %eax,%edx
    13da:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13dd:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    13e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13e3:	8b 40 04             	mov    0x4(%eax),%eax
    13e6:	c1 e0 03             	shl    $0x3,%eax
    13e9:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    13ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13ef:	8b 55 ec             	mov    -0x14(%ebp),%edx
    13f2:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    13f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13f8:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
      return (void*)(p + 1);
    13fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1400:	83 c0 08             	add    $0x8,%eax
    1403:	eb 3b                	jmp    1440 <malloc+0xe1>
    }
    if(p == freep)
    1405:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    140a:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    140d:	75 1e                	jne    142d <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    140f:	83 ec 0c             	sub    $0xc,%esp
    1412:	ff 75 ec             	pushl  -0x14(%ebp)
    1415:	e8 e5 fe ff ff       	call   12ff <morecore>
    141a:	83 c4 10             	add    $0x10,%esp
    141d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1420:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1424:	75 07                	jne    142d <malloc+0xce>
        return 0;
    1426:	b8 00 00 00 00       	mov    $0x0,%eax
    142b:	eb 13                	jmp    1440 <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    143b:	e9 6d ff ff ff       	jmp    13ad <malloc+0x4e>
}
    1440:	c9                   	leave  
    1441:	c3                   	ret    

00001442 <hufs_thread_create>:
...
int hufs_thread_create(void *func(), void *args)
{
    ...
    144b:	68 00 10 00 00       	push   $0x1000
    1450:	e8 0a ff ff ff       	call   135f <malloc>
    1455:	83 c4 10             	add    $0x10,%esp
    1458:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
    145b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    145f:	75 07                	jne    1468 <hufs_thread_create+0x26>
    1461:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1466:	eb 42                	jmp    14aa <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
    1468:	83 ec 04             	sub    $0x4,%esp
    146b:	ff 75 f4             	pushl  -0xc(%ebp)
    146e:	ff 75 0c             	pushl  0xc(%ebp)
    1471:	ff 75 08             	pushl  0x8(%ebp)
    1474:	e8 2c fb ff ff       	call   fa5 <clone>
    1479:	83 c4 10             	add    $0x10,%esp
    147c:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
    147f:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
    1483:	75 15                	jne    149a <hufs_thread_create+0x58>
		free(stack);
    1485:	83 ec 0c             	sub    $0xc,%esp
    1488:	ff 75 f4             	pushl  -0xc(%ebp)
    148b:	e8 8d fd ff ff       	call   121d <free>
    1490:	83 c4 10             	add    $0x10,%esp
		return -1;
    1493:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1498:	eb 10                	jmp    14aa <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
    149a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    149d:	8b 55 f4             	mov    -0xc(%ebp),%edx
    14a0:	89 14 85 60 1b 00 00 	mov    %edx,0x1b60(,%eax,4)
...
int hufs_thread_join(int pid)
{
    ...
    14b5:	8b 04 85 60 1b 00 00 	mov    0x1b60(,%eax,4),%eax
    14bc:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (stack==0) return -1;
    14bf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14c3:	75 07                	jne    14cc <hufs_thread_join+0x20>
    14c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    14ca:	eb 28                	jmp    14f4 <hufs_thread_join+0x48>

	join(&thread_info[pid].stack);	
    14cc:	8b 45 08             	mov    0x8(%ebp),%eax
    14cf:	c1 e0 02             	shl    $0x2,%eax
    14d2:	05 60 1b 00 00       	add    $0x1b60,%eax
    14d7:	83 ec 0c             	sub    $0xc,%esp
    14da:	50                   	push   %eax
    14db:	e8 cd fa ff ff       	call   fad <join>
    14e0:	83 c4 10             	add    $0x10,%esp
	free(stack);
    14e3:	83 ec 0c             	sub    $0xc,%esp
    14e6:	ff 75 f4             	pushl  -0xc(%ebp)
    14e9:	e8 2f fd ff ff       	call   121d <free>
