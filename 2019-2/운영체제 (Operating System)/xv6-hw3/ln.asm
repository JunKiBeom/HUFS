...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	0f b6 80 a8 0b 00 00 	movzbl 0xba8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 55a:	75 25                	jne    581 <printf+0xff>
          s = "(null)";
 55c:	c7 45 f4 13 09 00 00 	movl   $0x913,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 622:	a1 c8 0b 00 00       	mov    0xbc8,%eax
...
free(void *ap)
{
 ...
 6ed:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 6f2:	90                   	nop
 6f3:	c9                   	leave  
 6f4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 74b:	83 c4 10             	add    $0x10,%esp
  return freep;
 74e:	a1 c8 0b 00 00       	mov    0xbc8,%eax
}
 753:	c9                   	leave  
 754:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 767:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 76a:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 76f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 772:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 776:	75 23                	jne    79b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 778:	c7 45 f0 c0 0b 00 00 	movl   $0xbc0,-0x10(%ebp)
 77f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 782:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 787:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 78c:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    base.s.size = 0;
 791:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 798:	00 00 00 
  }
 ...
 7ee:	a3 c8 0b 00 00       	mov    %eax,0xbc8
      return (void*)(p + 1);
 ...
 7f9:	eb 3b                	jmp    836 <malloc+0xe1>
    ...
    if(p == freep)
 7fb:	a1 c8 0b 00 00       	mov    0xbc8,%eax
