...
printint(int fd, int xx, int base, int sgn)
{
 ...
 567:	0f b6 80 20 0d 00 00 	movzbl 0xd20(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6a3:	75 25                	jne    6ca <printf+0xff>
          s = "(null)";
 6a5:	c7 45 f4 6d 0a 00 00 	movl   $0xa6d,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 76b:	a1 48 0d 00 00       	mov    0xd48,%eax
...
free(void *ap)
{
 ...
 836:	a3 48 0d 00 00       	mov    %eax,0xd48
}
 83b:	90                   	nop
 83c:	c9                   	leave  
 83d:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 894:	83 c4 10             	add    $0x10,%esp
  return freep;
 897:	a1 48 0d 00 00       	mov    0xd48,%eax
}
 89c:	c9                   	leave  
 89d:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8b0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8b3:	a1 48 0d 00 00       	mov    0xd48,%eax
 8b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8bb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8bf:	75 23                	jne    8e4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8c1:	c7 45 f0 40 0d 00 00 	movl   $0xd40,-0x10(%ebp)
 8c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8cb:	a3 48 0d 00 00       	mov    %eax,0xd48
 8d0:	a1 48 0d 00 00       	mov    0xd48,%eax
 8d5:	a3 40 0d 00 00       	mov    %eax,0xd40
    base.s.size = 0;
 8da:	c7 05 44 0d 00 00 00 	movl   $0x0,0xd44
 8e1:	00 00 00 
  }
 ...
 937:	a3 48 0d 00 00       	mov    %eax,0xd48
      return (void*)(p + 1);
 ...
 942:	eb 3b                	jmp    97f <malloc+0xe1>
    ...
    if(p == freep)
 944:	a1 48 0d 00 00       	mov    0xd48,%eax
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 98a:	68 00 10 00 00       	push   $0x1000
 98f:	e8 0a ff ff ff       	call   89e <malloc>
 994:	83 c4 10             	add    $0x10,%esp
 997:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 99a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 99e:	75 07                	jne    9a7 <hufs_thread_create+0x26>
 9a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 9a5:	eb 42                	jmp    9e9 <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
 9a7:	83 ec 04             	sub    $0x4,%esp
 9aa:	ff 75 f4             	pushl  -0xc(%ebp)
 9ad:	ff 75 0c             	pushl  0xc(%ebp)
 9b0:	ff 75 08             	pushl  0x8(%ebp)
 9b3:	e8 2c fb ff ff       	call   4e4 <clone>
 9b8:	83 c4 10             	add    $0x10,%esp
 9bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
 9be:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
 9c2:	75 15                	jne    9d9 <hufs_thread_create+0x58>
		free(stack);
 9c4:	83 ec 0c             	sub    $0xc,%esp
 9c7:	ff 75 f4             	pushl  -0xc(%ebp)
 9ca:	e8 8d fd ff ff       	call   75c <free>
 9cf:	83 c4 10             	add    $0x10,%esp
		return -1;
 9d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 9d7:	eb 10                	jmp    9e9 <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
 9d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9dc:	8b 55 f4             	mov    -0xc(%ebp),%edx
 9df:	89 14 85 60 0f 00 00 	mov    %edx,0xf60(,%eax,4)
...
int hufs_thread_join(int pid)
{
 ...
 9f4:	8b 04 85 60 0f 00 00 	mov    0xf60(,%eax,4),%eax
 9fb:	89 45 f4             	mov    %eax,-0xc(%ebp)

	if (stack==0) return -1;
 9fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 a02:	75 07                	jne    a0b <hufs_thread_join+0x20>
 a04:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a09:	eb 28                	jmp    a33 <hufs_thread_join+0x48>

	join(&thread_info[pid].stack);	
 a0b:	8b 45 08             	mov    0x8(%ebp),%eax
 a0e:	c1 e0 02             	shl    $0x2,%eax
 a11:	05 60 0f 00 00       	add    $0xf60,%eax
 a16:	83 ec 0c             	sub    $0xc,%esp
 a19:	50                   	push   %eax
 a1a:	e8 cd fa ff ff       	call   4ec <join>
 a1f:	83 c4 10             	add    $0x10,%esp
	free(stack);
 a22:	83 ec 0c             	sub    $0xc,%esp
 a25:	ff 75 f4             	pushl  -0xc(%ebp)
 a28:	e8 2f fd ff ff       	call   75c <free>
