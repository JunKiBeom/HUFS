...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41c:	0f b6 80 94 0b 00 00 	movzbl 0xb94(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	75 25                	jne    57f <printf+0xff>
          s = "(null)";
 55a:	c7 45 f4 fe 08 00 00 	movl   $0x8fe,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 620:	a1 c8 0b 00 00       	mov    0xbc8,%eax
...
free(void *ap)
{
 ...
 6eb:	a3 c8 0b 00 00       	mov    %eax,0xbc8
}
 6f0:	90                   	nop
 6f1:	c9                   	leave  
 6f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 749:	83 c4 10             	add    $0x10,%esp
  return freep;
 74c:	a1 c8 0b 00 00       	mov    0xbc8,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 768:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 c0 0b 00 00 	movl   $0xbc0,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 785:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 78a:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    base.s.size = 0;
 78f:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 796:	00 00 00 
  }
 ...
 7ec:	a3 c8 0b 00 00       	mov    %eax,0xbc8
      return (void*)(p + 1);
...
int hufs_thread_create(void *func(), void *args)
{
 ...
 83f:	68 00 10 00 00       	push   $0x1000
 844:	e8 0a ff ff ff       	call   753 <malloc>
 849:	83 c4 10             	add    $0x10,%esp
 84c:	89 45 f4             	mov    %eax,-0xc(%ebp)
	if (stack==0) return -1;
 84f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 853:	75 07                	jne    85c <hufs_thread_create+0x26>
 855:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 85a:	eb 42                	jmp    89e <hufs_thread_create+0x68>

	pid = clone(func, args, stack); 
 85c:	83 ec 04             	sub    $0x4,%esp
 85f:	ff 75 f4             	pushl  -0xc(%ebp)
 862:	ff 75 0c             	pushl  0xc(%ebp)
 865:	ff 75 08             	pushl  0x8(%ebp)
 868:	e8 2c fb ff ff       	call   399 <clone>
 86d:	83 c4 10             	add    $0x10,%esp
 870:	89 45 f0             	mov    %eax,-0x10(%ebp)
	if (pid==-1) {
 873:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
 877:	75 15                	jne    88e <hufs_thread_create+0x58>
		free(stack);
 879:	83 ec 0c             	sub    $0xc,%esp
 87c:	ff 75 f4             	pushl  -0xc(%ebp)
 87f:	e8 8d fd ff ff       	call   611 <free>
 884:	83 c4 10             	add    $0x10,%esp
		return -1;
 887:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 88c:	eb 10                	jmp    89e <hufs_thread_create+0x68>
	}

	thread_info[pid].stack = stack; 
 88e:	8b 45 f0             	mov    -0x10(%ebp),%eax
 891:	8b 55 f4             	mov    -0xc(%ebp),%edx
 894:	89 14 85 e0 0b 00 00 	mov    %edx,0xbe0(,%eax,4)
