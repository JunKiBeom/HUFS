...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43a:	0f b6 80 c8 0b 00 00 	movzbl 0xbc8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 576:	75 25                	jne    59d <printf+0xff>
          s = "(null)";
 578:	c7 45 f4 35 09 00 00 	movl   $0x935,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63e:	a1 e8 0b 00 00       	mov    0xbe8,%eax
...
free(void *ap)
{
 ...
 709:	a3 e8 0b 00 00       	mov    %eax,0xbe8
}
 70e:	90                   	nop
 70f:	c9                   	leave  
 710:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 767:	83 c4 10             	add    $0x10,%esp
  return freep;
 76a:	a1 e8 0b 00 00       	mov    0xbe8,%eax
}
 76f:	c9                   	leave  
 770:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 783:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 786:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 78b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 792:	75 23                	jne    7b7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 794:	c7 45 f0 e0 0b 00 00 	movl   $0xbe0,-0x10(%ebp)
 79b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79e:	a3 e8 0b 00 00       	mov    %eax,0xbe8
 7a3:	a1 e8 0b 00 00       	mov    0xbe8,%eax
 7a8:	a3 e0 0b 00 00       	mov    %eax,0xbe0
    base.s.size = 0;
 7ad:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 7b4:	00 00 00 
  }
 ...
 815:	eb 3b                	jmp    852 <malloc+0xe1>
    ...
    if(p == freep)
 817:	a1 e8 0b 00 00       	mov    0xbe8,%eax
